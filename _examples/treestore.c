...
int main(int argc, char *argv[])
{
    ...
    gtk_tree_store_set(treestore, &treeiter, 0, "Mageia", -1);
    gtk_tree_store_append(treestore, &treeiter, &treeiter);
    gtk_tree_store_set(treestore, &treeiter, 0, "http://www.mageia.org/", -1);
    gtk_tree_store_append(treestore, &treeiter, NULL);
    ...
    gtk_tree_store_append(treestore, &treeiter, &treeiter);
    gtk_tree_store_set(treestore, &treeiter, 0, "http://chakraos.org/", -1);
